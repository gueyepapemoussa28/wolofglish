...
const REGLES = [
  ...
  // Les voyelles longues du wolof : le français ne les tient pas, on les
  // ramène à une seule. « ée » et « óo » se traitent avant que ó ne devienne
  // ô, sans quoi ils échappent à la règle et ressortent « éèy » ou « ôo ».
  [/aa/g, "a"],
  [/([éeiouó])\1/g, "$1"],
  [/ée/g, "é"],
  [/ee/g, "é"],
